...
-- Volcando datos para la tabla asistencialito.asistencias: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla asistencialito.institucion: ~1 rows (aproximadamente)
